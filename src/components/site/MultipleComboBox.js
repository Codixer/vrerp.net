...
const MultipleComboBox = ({
  ...
  const shownItems = useMemo(
    () => getFilteredItems(items, selectedItems, inputValue),
    ...
    onStateChange({
      ...
      switch (type) {
        ...
        case useCombobox.stateChangeTypes.ItemClick:
          setSelectedItems([
            ...selectedItems,
            newSelectedItem ? newSelectedItem : inputValue,
          ]);
          if (updatedItems) {
            updatedItems([
              ...selectedItems,
  ...
  return (
    <div className="w-[592px]">
      ...
      <List {...getMenuProps()} className="combobox-panel">
        {isOpen &&
          shownItems.map((item, index) => (
            <li
              className={classNames("drac-text", {
