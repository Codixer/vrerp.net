    ...
    return (
        <div>
            ...
            <Helmet
                ...
                meta={[
                    { name: 'description', content: `${ profile.username } has invited you to vrerp.net!` }
                ]}
            />
            ...
            <br /><br /><br />
            vrerp.net is the first erp-specific matchmaking site for finding new partners for vr erp, and keeping in touch with your lewdies 😊
            <br /><br />
            Click below to accept their invite and join the site:<br />
            <LoginFields />
        </div>
    );
}
