...
export const LoginFields = ({ redirectUrl }) => {
    ...
    const discordLogin = useMemo(() => `${ url }api/discord/auth`.replace(/\//g, '%2F'), [ url ]);
    const state = redirectUrl ? `&state=${ encodeURI(redirectUrl) }` : '';
    return (
        <div>
            <Heading size="md" p="sm">Sign up, or log in with discord</Heading>
            <center>
                <a href={ `https://discord.com/api/oauth2/authorize?client_id=1087160580990832741&redirect_uri=${ discordLogin }&response_type=code&scope=identify${ state }` }>
                    <img src="https://cdn.vrerp.net/login-with-discord.png" alt="log in with discord" className='landing-login-btn track-login-btn' />
                </a><br />
                <Text size="sm">(We use your discord username only. This does not allow us to do anything else with your discord account.)</Text>
            </center>
        </div>
    );
}
...
export const NotPublic = ({ url, ...metaprops }) => (
    <div className='drac-m-sm'>
        ...
        <Header />
        <br />
        You need to be a member to see this page.<br /><br />
...
export const NotPublicMedia = ({ url, id }) => {
    ...
    return <NotPublic url={ url } title={ `vibe pics 💕 - vrerp.net` } 
        meta={[
...
export const LandingPics = () => {
    return (
        <center className='landing-image-container'>
            <img src="https://cdn.vrerp.net/frontpage/pic-1-ori-thm.png" className='landing-image' />
            <img src="https://cdn.vrerp.net/frontpage/pic-1-ori-thm.png" className='landing-image' />
            <img src="https://cdn.vrerp.net/frontpage/pic-1-ori-thm.png" className='landing-image' />
            <img src="https://cdn.vrerp.net/frontpage/pic-1-ori-thm.png" className='landing-image' />
        </center>
...
export const LandingPage = () => {
    return (
        <div>
            ...
            <Heading size="md" p="sm">How do I join?</Heading>
            <LoginFields />
            <Heading size="md" p="sm">Join our discord server to chat</Heading>
            <center>
                <a href={ 'https://discord.gg/HDZQP6Wb6f' } target='_blank' rel='noreferrer'>
                    <img src="https://cdn.vrerp.net/join-discord.png" alt="join our discord server" className='landing-login-btn' />
                </a>
            </center>
            💕love,<br />
            - The lewd admins
