    ...
    <div className="modal-content">
      {!isPosted && (
        <div>
          ...
          <br />
          <br />
          We welcome any ERP-related item suggestions (self-promotion, or
          otherwise); we&apos;d especially love to feature, and promote more
          BDSM, and kink-related stuff: gags, cuffs, armbinders 💕, in avatar,
          or accessory form 🥰
          <br />
          <br />
          ...
          <br />
          <InputBox
            placeholder="https://mystore.gumroad.com/..."
            value={url}
            onBlur={(evt) => setUrl(evt.target.value)}
          />
          <br />
          <center>
            <Button onClick={publishAsset} disabled={loading}>
              Publish
            </Button>
          </center>
          <br />
      ...
      {isPosted && (
        <div>
          ...
          <center>
            ...
            <br />
            <br />
            <Button onClick={() => setIsPosted(false)} disabled={loading}>
              Publish another one
            </Button>
          </center>
          <br />
