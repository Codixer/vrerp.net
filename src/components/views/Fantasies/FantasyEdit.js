...
const FantasyEdit = ({ id }) => {
  ...
  return (
    ...
    >
      <div>
        <b>What makes your heart flutter? 💕</b>
        <br />
        <br />
        <InputArea
          name="text"
          ...
          value={fantasy.text}
          className="fantasy-edit-box"
          placeholder="other lewdies with..."
        />
        <br />
        <br />
        <b>
          (optional) source: (if pasted, respect the artist with a link to the
          original)
        </b>
        <InputBox
          name="link"
        ...
        <Button
          onClick={onSubmit}
          disabled={loading}
          className="drac-btn drac-bg-purple drac-btn-outline drac-text-purple drac-p-sm"
        >
          Post fantasy 🦋
        </Button>
      </div>
