...
const DeleteProfile = () => {
  ...
  return (
    <div>
      ...
      <br />
      WARNING: This will delete all your data, images, connections, and profiles
      associated with your account.
      <br />
      For privacy reasons, this function is 100% ruthless; there is no undo
      button.
      <br />
      Please double-check, that you want to delete:
      <br />
      <br />
