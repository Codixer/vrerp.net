...
const DangerousSettings = ({ id }) => {
  ...
  const resetPasses = useCallback(async () => {
    setLoading(true);
    await deleteDataAndUpdateStore(
      profileStore,
      "/api/match/passes",
      updateFeed
    );
  ...
  return (
    <div>
      ...
      <Button
        ...
        onClick={() => setVisibleModal(MODAL_DELETE_PASSES)}
      >
        Reset passes
      </Button>
      <br />
      ...
      <Button
        className={outlinedButton}
        onClick={() => setVisibleModal(MODAL_DEACTIVATE_ACCOUNT)}
      >
        Deactivate account
      </Button>
      <Modal
        show={visibleModal === MODAL_DELETE_PASSES}
        onClose={() => setVisibleModal(null)}
      >
        <div className="modal-content">
          <br />
          This will delete all your previous passes
          <br />
          <br />
          <Button
            className={outlinedButton}
      ...
      <Modal
        show={visibleModal === MODAL_DEACTIVATE_ACCOUNT}
        onClose={() => setVisibleModal(null)}
      >
        <div className="modal-content">
          <br />
          This will deactivate your account. You can reactivate any time, by
          logging in, and clicking reactivate.
          <br />
          <br />
          <Button
            className={outlinedButton}
