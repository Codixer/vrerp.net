...
export const Matches = () => {
    ...
    const missingProfiles = useMemo(() => matches.filter((profileId) => !profileList.includes(profileId) ), [ matches, profileList ]);
    return (
        <div>
            ...
            >
                {
                    (missingProfiles.length === 0) && matches.map((id) => (
                ...
                {
                    (missingProfiles.length === 0 && matches.length === 0) && <div className='drac-m-sm'>
