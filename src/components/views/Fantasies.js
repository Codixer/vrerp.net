...
const Fantasies = ({ url, header }) => {
  ...
  const missingFantasies = useMemo(
    () => list.filter((id) => !fantasies[id]),
    [list, fantasies]
  );
  ...
  return (
    <div>
      ...
      >
        ...
        share your sexual fantasies, and desires; situations and scenarios you
        find vibe 💕 makes you horny 😊 and find peeps who shares those desires
        <br />
        <br />
        <Button onClick={createFantasy} disabled={loading}>
          + Post a vibe fantasy
        </Button>
        <br />
        <br />
