...
export const Profile = mongoose.model('Profile', new Schema({
    ...
    link: String,
    yearOfBirth: Number,
    profileVisibility: { type: String, enum: ['draft', 'hidden', 'members', 'public'], default: 'draft' },
    discordVisibility: { type: String, enum: ['matches', 'members', 'public'], default: 'members' },
    fantasiesVisibility: { type: String, enum: ['matches', 'members', 'public'], default: 'members' },
    datesVisibility: { type: String, enum: ['matches', 'members'], default: 'matches' },
...
export const ProfileInternal = mongoose.model('ProfileInternal', new Schema({
    _id: Long,
    userId: Long,
    url: String,
    discord: String,
...
export const Kink = mongoose.model('Kink', new Schema({
    _id: Long,
    name: String,
