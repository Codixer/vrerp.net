...
export const publicObject = (data) => { return data ? { ... _.omit(data, ['_id', 'createdAt', 'updatedAt', '__v']), id: data['_id'] } : null };

export const fullAccess = (user) => user && user.profileId && user.roles && user.roles.includes('verified') && user.roles.includes('onboarded');
